...
const NavBar = () => {
  ...
  return (
    <nav
      className={`w-full bg-cardBG text-pinkText mb-4 ${
      ...
      <div className="justify-between px-4 mx-auto md:items-center md:flex md:px-8 max-w-7xl">
        ...
        >
          ...
          >
            ...
            <li
              className={`hover:text-blueText ${
                isActive("/om-meg") ? "underline" : "hover:underline"
              }`}
            >
            ...
            <li
              className={`hover:text-blueText ${
                isActive("/mine-prosjekter") ? "underline" : "hover:underline"
              }`}
            >
            ...
            <li
              className={`hover:text-blueText ${
                isActive("/mine-erfaringer") ? "underline" : "hover:underline"
              }`}
            >
